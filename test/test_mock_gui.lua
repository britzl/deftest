return function()
	...
	describe("mock.gui", function()
		...
		it("should be possible to create box nodes", function()
		...
		it("should be possible to delete nodes", function()
		...
		it("should be possible to parent nodes", function()
		...
		it("should be possible to get and set a node id", function()
			local node1 = gui.new_box_node(vmath.vector3(10, 10, 0), vmath.vector3(100, 100, 0))
			local node2 = gui.new_box_node(vmath.vector3(10, 10, 0), vmath.vector3(100, 100, 0))
		...
		it("should be possible to get a node based on id", function()
			local node1 = gui.new_box_node(vmath.vector3(10, 10, 0), vmath.vector3(100, 100, 0))
			local node2 = gui.new_box_node(vmath.vector3(10, 10, 0), vmath.vector3(100, 100, 0))
		...
		it("should be possible to pick a box node", function()
			local pos = vmath.vector3(10, 10, 0)
			local size = vmath.vector3(100, 100, 0)
			local node = gui.new_box_node(pos, size)
		...
		it("should be possible to pick enable and disable a node", function()
